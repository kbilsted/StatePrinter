...
namespace StatePrinter.Introspection
{
  ...
  public class Token : IEquatable<Token>
  {
    ...
    /// constructor method
    /// </summary>
    public static Token SeenBefore(string fieldName, Reference reference)
    {
      return new Token(TokenType.SeenBeforeWithReference, fieldName, null, reference, null);
    }

    public Token(TokenType type, string fieldName = null, string value = null, Reference reference = null, Type fieldFieldType = null)
    {
      Tokenkind = type;
      FieldName = fieldName;
